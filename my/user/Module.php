...
class Module extends \yii\base\Module
{
    ...
    /**
     * @var array Model classes, e.g., ["User" => "my\user\models\User"]
     * Usage:
     *   $user = Yii::$app->getModule("user")->model("User", $config);
     *   (equivalent to)
     *   $user = new \my\user\models\User($config);
     *
    ...
    protected function checkModuleProperties()
    {
        ...
        if ($userComponent && !$userComponent instanceof \my\user\components\User) {
            throw new InvalidConfigException('Yii::$app->user is not set properly. It needs to extend \my\user\components\User');
        }
    }
    ...
    protected function getDefaultModelClasses()
    {
        ...
        if (Yii::$app->get('user', false)) {
            ...
            $userClass = 'my\user\models\User';
        }

        return [
            'User' => $userClass,
            'Profile' => 'my\user\models\Profile',
            'Role' => 'my\user\models\Role',
            'UserToken' => 'my\user\models\UserToken',
            'UserAuth' => 'my\user\models\UserAuth',
            'ForgotForm' => 'my\user\models\forms\ForgotForm',
            'LoginForm' => 'my\user\models\forms\LoginForm',
            'ResendForm' => 'my\user\models\forms\ResendForm',
            'UserSearch' => 'my\user\models\search\UserSearch',
            'LoginEmailForm' => 'my\user\models\forms\LoginEmailForm',
        ];
    }
