...
class DefaultController extends Controller
{
    ...
    {
        /** @var \my\user\models\forms\LoginForm $model */
    ...
    {
        /** @var \my\user\models\forms\LoginEmailForm $loginEmailForm */
     ...
     * @param \my\user\models\User $user
     */
    ...
    {
        /** @var \my\user\models\forms\ResendForm $model */
    ...
    {
        /** @var \my\user\models\forms\ForgotForm $model */
